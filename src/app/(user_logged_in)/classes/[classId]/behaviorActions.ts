...
import { behaviors, classes, points, student_classes, teacher_classes } from '~/server/db/schema';
...
import type { PointRecord, PointType } from '~/server/db/types';
...
//             user_id: userId,
//             class_id: class_id,
//             student_id: student_data_array.student_id,
